...
# @File          : development.sh
# @Description   : development installer for centos/rhel
# @TODO          :
# @Other         :
# @Resource      :
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
[[ "$1" == "--help" ]] && printf_exit "${GREEN}development installer for centos/rhel"
...
##################################################################################################################
printf_head "Installing the packages for my development system"
##################################################################################################################
install_pkg acl
